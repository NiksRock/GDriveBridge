...
$excludePattern = "node_modules|project_source_dump.txt|print-structure.ps1|README.md|.env|dist|.turbo|.vite|clean.ps1|.pnpm|prisma[\\/]migrations|.husky[\\/]_|tsconfig.tsbuildinfo|package-lock.json|.png|.jpg|.svg|.ico"
